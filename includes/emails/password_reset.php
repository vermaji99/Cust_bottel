...
<div style="font-family:'Poppins',Arial,sans-serif;background:#0b0b0b;color:#fff;padding:30px;">
  ...
  <p>We received a request to reset your Bottle password. Click the button below to continue. This secure link expires in 30 minutes.</p>
  ...
  <p style="margin-top:40px;color:#aaa;">Stay hydrated,<br>Bottle Support</p>
</div>
